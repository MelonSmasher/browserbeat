...
--
This document describes the fields that are exported by Browserbeat. They are
grouped in the following categories:

* <<exported-fields-beat-common>>
* <<exported-fields-browserbeat>>
...
+
--
Date/time when the user visited the URL.
...
+
--
Date/time when the history entry was processed.
...
Contains the machines FQDN and short hostname.


*`data.host.hostname`*::
+
--
The machines full FQDN.
...
Contains data about the local machine and the browser history record.


*`data.event.module`*::
+
--
The elastic beat name and current browser
...
Contains the history entry and client info


[float]
=== entry

Contains the browser history record.


*`data.event.data.entry.date`*::
+
--
Date/time when the user visited the URL.
...
+
--
The URL obtained from the browser history.
...
*`data.event.data.entry.title`*::
+
--
The website title obtained from the browser history.
...
The url broken down into parsed pieces.


[float]
=== User

Any username and password information


*`data.event.data.entry.url_data.User.username`*::
+
--
The username
...
*`data.event.data.entry.url_data.User.password`*::
+
--
The password
...
*`data.event.data.entry.url_data.User.passwordSet`*::
+
--
type: boolean
...
*`data.event.data.entry.url_data.Host`*::
+
--
...
*`data.event.data.entry.url_data.RawPath`*::
+
--
The encoded path hint (see EscapedPath method)
...
*`data.event.data.entry.url_data.ForceQuery`*::
+
--
The if the url had forced a ? at the end
...
*`data.event.data.entry.url_data.Fragment`*::
+
--
The fragment for references, without #
...
*`data.event.data.entry.url_data.Scheme`*::
+
--
The scheme used to access the content.
...
*`data.event.data.entry.url_data.Path`*::
+
--
The path (relative paths may omit leading slash)
...
*`data.event.data.entry.url_data.RawQuery`*::
+
--
The encoded query values, without ?
...
*`data.event.data.entry.url_data.Opaque`*::
+
--
Any encoded opaque data.
...
Contains data about the local machine.


*`data.event.data.client.ip_addresses`*::
+
--
A list of the non-local ip addresses on this machine.
...
*`data.event.data.client.user`*::
+
--
The username of the user profile that this history entry was pulled from.
...
*`data.event.data.client.platform`*::
+
--
The GOOS platform.
...
*`data.event.data.client.browser`*::
+
--
The browser of the user profile that this history entry was pulled from.
...
*`data.event.data.client.Hostname.hostname`*::
+
--
The machines full FQDN.
...
*`data.event.data.client.Hostname.short`*::
+
--
The machines short name.
